...
const ReservationPanelReserve = () => {
  return (
    <StyledWrapper>
      ...
      환불은 입금자 확인 후 입금하신 분의 계좌 및 결제 카드로 환불됩니다. <br />
      예약 변경시, 기존 예약을 취소 후 예약 하셔야 합니다. <br />
      임의로 예약을 변경해 드리는 경우는 재난재해 등에 준하는 사유가 있는 경우에
      한합니다. <br />
      천재지변으로 인한 당일 항공편/배편이 취소된 경우, <br />
      그에 상응한 증빙자료 제출 후, 당일 숙박료에 한하여 100% 환불이 가능합니다.{' '}
      <br />
      <br />
      이용 9~5일 전 - 총 결제금액의 50% 차감 <br />
      이용 4일 전. 총 결제금액의 60% 차감 <br />
      이용 3일 전 . 총 결제금액의 70% 차감 <br />
      이용 2일 전-총결제금액의 80% 차감 <br />
